...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   lexing_bdd_two_words.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: tchobert <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/26 16:34:52 by tchobert          #+#    #+#             */
/*   Updated: 2024/12/26 16:35:07 by tchobert         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	test_input_two_words(void)
{
	...
	TEST_ASSERT_EQUAL(0, ft_strcmp(((t_token *)current->content)->token_lexem, "World!"));
	current = (t_token_list)current->next;
